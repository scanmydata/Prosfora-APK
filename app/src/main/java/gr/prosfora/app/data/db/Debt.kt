...
data class DebtEntity(
    ...
    val source: String = "",
    /**
     * Ποιος την καταχώρησε — η διεύθυνση του λογαριασμού Google.
     *
     * Σε κοινόχρηστη βάση είναι η μόνη πληροφορία που λέει ότι η οφειλή ήρθε
     * από συνεργάτη και όχι από εμένα, ακόμη κι όταν δεν υπάρχει παραστατικό.
     */
